...
class Feed extends Component {
  ...
  componentDidMount() {
    fetch("https://nodejs-react-api.herokuapp.com/auth/status", {
      headers: {
    ...
    const socket = openSocket(
      "https://nodejs-react-api.herokuapp.com",
      connectionOptions
    );
  ...
  loadPosts = (direction) => {
    ...
    fetch("https://nodejs-react-api.herokuapp.com/feed/posts?page=" + page, {
      headers: {
        Authorization: "Bearer " + this.props.token,
      },
    })
  ...
  statusUpdateHandler = (event, resData) => {
  ...
  finishEditHandler = (postData) => {
    ...
    let url = "https://nodejs-react-api.herokuapp.com/feed/post/";
    let method = "POST";
    if (this.state.editPost) {
      url =
        "https://nodejs-react-api.herokuapp.com/feed/post/" +
  ...
  deletePostHandler = (postId) => {
    ...
    fetch("https://nodejs-react-api.herokuapp.com/feed/post/" + postId, {
      method: "DELETE",
      headers: {
        Authorization: "Bearer " + this.props.token,
      },
